...
export class InstitutionController {
    ...
    @Get()
    @ApiOperation({ summary: 'ค้นหาสถาบัน', description: 'ค้นหาสถาบันตามเงื่อนไขที่กำหนด' })
    ...
    @Put(':id')
    @ApiOperation({ summary: 'อัปเดตข้อมูลสถาบัน', description: 'แก้ไขข้อมูลสถาบันตาม ID' })
    @ApiParam({ name: 'id', description: 'รหัสสถาบัน', type: Number })
    @ApiBody({ type: UpdateInstitutionDto })
    @ApiResponse({ status: 200, description: 'อัปเดตสำเร็จ' })
    @ApiResponse({ status: 404, description: 'ไม่พบสถาบัน' })
    async updateInstitution(@Param('id') id: number, @Body() dto: UpdateInstitutionDto) {
    ...
    @ApiOperation({ summary: 'สร้างสถาบันใหม่', description: 'ลงทะเบียนสถาบันใหม่ในระบบ' })
    ...
    @Delete(':id')
    @ApiOperation({ summary: 'ลบสถาบัน', description: 'ลบสถาบันออกจากระบบตาม ID' })
    @ApiParam({ name: 'id', description: 'รหัสสถาบัน', type: Number })
    ...
    @ApiOperation({ summary: 'เข้าสู่ระบบสถาบัน', description: 'เข้าสู่ระบบด้วย email และ password เพื่อรับ JWT token' })
