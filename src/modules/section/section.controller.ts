...
export class SectionController {
  ...
  @ApiResponse({
    status: 200,
    description: 'Section educators retrieved successfully',
  })
  @ApiResponse({ status: 400, description: 'No search parameters provided' })
  ...
  @ApiResponse({
    status: 400,
    description: 'Missing required fields or invalid time format',
  })
  ...
  @ApiOperation({
    summary: 'Create section with schedule together (transaction)',
  })
  @ApiResponse({
    status: 201,
    description: 'Section and schedule created successfully',
  })
  @ApiResponse({ status: 400, description: 'Missing required fields' })
  ...
  @ApiResponse({
    status: 201,
    description: 'Section educator created successfully',
  })
  @ApiResponse({ status: 400, description: 'Missing required fields' })
  @ApiResponse({
    status: 409,
    description: 'Educator already added to section',
  })
  ...
  @ApiResponse({
    status: 409,
    description: 'Student already enrolled in section',
  })
  ...
  @ApiResponse({
    status: 200,
    description: 'Section and schedule updated successfully',
  })
  ...
  @ApiResponse({
    status: 200,
    description: 'Section educator updated successfully',
  })
  ...
  @ApiResponse({
    status: 200,
    description: 'Section educator deleted successfully',
  })
